...
([../development-rules.md 6.4](../development-rules.md#64-로깅--운영-로그와-감사-로그를-나눈다)).
...
([../api-contract.md 3장](../api-contract.md#3-멱등성--같은-거래가-두-번-들어가지-않게)).
...
헤더 규약 전체는 [../api-contract.md 2장](../api-contract.md#2-헤더--누가-무엇을-대신하는가)에 있다.
